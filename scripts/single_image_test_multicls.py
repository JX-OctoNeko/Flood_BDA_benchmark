...
def load_image(path, valid_values=None, mapping=None):
    """
...
def main(gt_path, pred_path):
    ...
    gt = load_image(gt_path, valid_values=valid_values)
    pred = load_image(pred_path, valid_values=valid_values, mapping=mapping)
...
if __name__ == "__main__":
    ...
    gt_path = "src/data/xView/Process2/test/label/nepal-flooding_00000023_disaster/nepal-flooding_00000023_disaster_0.png"  
    pred_path = "exp/xview-50%-1/out/epoch_149/lunet/nepal-flooding_00000023_disaster_0.png" 
