...
group_mapping = {
    ...
    'P2V': 'Temporal Modeling', 
    'LUNet': 'Temporal Modeling',
    'BIT': 'Self Attention based', 
    'SPADANet': 'U-Net with Prior Attention'
}
color_palette = {
    'U-Net based': '#1f77b4', 
    'FCN based': '#ff7f0e', 
    'Temporal Modeling': '#9467bd', 
    'Self Attention based': '#2ca02c',
    'U-Net with Prior Attention': '#d62728'
}
marker_palette = {
    'U-Net based': 'o',
    'FCN based': 's', 
...
if __name__ == "__main__":
    ...
    if main_df is not None:
        ...
        plot_grouped_scatter(df=main_df, x_col='Params', y_col='F1',
                             ...
                             filename='scripts\paint_perform_compare\scatter_plots\grouped_perf_vs_params.png')
        ...
        plot_grouped_scatter(df=main_df, x_col='Year', y_col='F1',
                             ...
                             filename='scripts\paint_perform_compare\scatter_plots\grouped_perf_vs_year.png',
                             is_year_plot=True)
